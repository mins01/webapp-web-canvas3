export default class BaseTool {
	...
	init(){
		...
		if(this.layer){ Object.assign(this.layer.ctx,this.editor.contextConfig.toObject());}
		if(this.drawLayer){ Object.assign(this.drawLayer.ctx,this.editor.contextConfig.toObject());}
	}
	start(){
		this.init();
	}
